...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form id="loginForm" action="#" method="#">
            ...
            <div class="form-group has-feedback">
                <input name="check" type="text" class="form-control" placeholder="请输入验证码" autocomplete="off"
                       style="float:left;width:200px;">
                <span style="float:right;"><img id="checkimg" src="${pageContext.request.contextPath}/user/Verification"
            ...
            <div class="row">
                <div class="col-xs-8">
                    <label>
                        <input name="isremove" type="checkbox"> 记住密码，七天内免登陆
                    </label>
                </div>
                <!-- /.col -->
                <div class="col-xs-4">
...
<script>
    ...
    var cookie = $.cookie('wulala');
    if (cookie != null) {
        $.post("/user/login", null, function (data) {
            if (data.flag) {
                if (data.user === 0) {
