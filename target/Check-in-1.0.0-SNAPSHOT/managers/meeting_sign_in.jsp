                            ...
                            <form id="sumitdelect" action="/Meeting/delectMeeting" method="post">
                                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th class="">会议时间</th>
                                        <th class="">会议地点</th>
                                        <th style="text-align:center">签到管理</th>
                                    </tr>
                                    </thead>
                                    <tbody id="list">
        ...
        $.get("/Meeting/meetinglist", {currentPage: currenpage,id:${manager.id}}, function (pb) {
            ...
            for (var i = 0; i < pb.list.length; i++) {
                ...
                var li = '<tr>\n' +
                    ...
                    '\n' +
                    '                                        <td class="text-center">\n' +
                    '                                            <a href="manage_ys.jsp?id=' + route.id + '" class="btn bg-olive btn-sm">查看签到情况</a>\n' +
                    '                                            <a href="/Meeting/sendNotice?id=' + route.id + '" class="btn bg-olive btn-sm">通知会议人员</a>\n' +
                    '                                          <a  href="../Signin/face.jsp?mid='+route.id+'" class="btn bg-olive btn-sm">进入签到页面</a>' +
                    '\n' +
                    '                                        </td>\n' +
                    '                                    </tr>'
