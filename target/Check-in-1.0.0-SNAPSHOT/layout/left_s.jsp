...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li id="admin-index"><a href="../surper/surper.jsp"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>
