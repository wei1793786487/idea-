...
public class MsgUtils {
    ...
    public static int SetNotice(String[] phones, String UserName, String MeetingName,String time,String time2, String Place) {
//        尊敬的{1},{2}会议将在{3}在{4}开始，请按时到场。如非本人操作，请忽略本短信。
        // 需要发送短信的手机号码
        String[] phoneNumbers = phones;
        try {
            String[] params = {UserName, MeetingName,time,time2,Place};//数组具体的元素个数和模板中变量个数必须一致，例如事例中templateId:5678对应一个变量，参数数组中元素个数也必须是一个
            SmsSingleSender ssender = new SmsSingleSender(appid, appkey);
