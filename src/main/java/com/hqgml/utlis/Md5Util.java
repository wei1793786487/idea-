...
public final class Md5Util {
    ...
    public static String encodeBySha(String password) throws Exception {
        //Java中MessageDigest类封装了MD5和SHA算法，今天我们只要MD5算法
        MessageDigest SHA = MessageDigest.getInstance("SHA");
        //调用MD5算法，即返回16个byte类型的值
        byte[] byteArray = SHA.digest(password.getBytes());
        //注意：MessageDigest只能将String转成byte[]，接下来的事情，由我们程序员来完成
        return byteArrayToHexString(byteArray);
    }

    public static String GetSHA_MD5(String password) throws Exception {
//		双层加密
        return encodeBySha(encodeByMd5(password));
    }
...
//        String SHA = Md5Util.encodeBySha(password);
//        System.out.println("sha算法" + SHA);
//        System.out.println(password);
//        System.out.println(passwordMD5);
//		String md5 = Md5Util.GetSHA_MD5("123");
//		System.out.println(md5);
//		for (int i = 0; i <20 ; i++) {
//			System.out.println(Md5Util.GetSHA_MD5("123"));
//		}
	}
}
