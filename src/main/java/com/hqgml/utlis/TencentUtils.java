...
public class TencentUtils {
    ...
    static {
        try {
            ...
            properties.load(new InputStreamReader(TencentUtils.class.getClassLoader().getResourceAsStream("FaceRecognition.properties"), "GBK"));
            secreid = properties.getProperty("secreid");
